...
function send_msg() {
    ...
    send_request2(request, openai_history);
...
function send_request(request){
    ...
    //     return;
    // }
    // setTimeout(send_request, 50, request);
    request.send();
}

function send_request2(request, content){
    // if(valid_status === 2){
    //     return;
    // }
    // if(valid_status === 1){
    ...
    //     return;
    // }
    // setTimeout(send_request2, 50, request, content);
    request.send(content);
}
